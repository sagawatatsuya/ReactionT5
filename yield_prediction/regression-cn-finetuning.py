...
try: # load pretrained tokenizer from local directory
    tokenizer = AutoTokenizer.from_pretrained(CFG.model_name_or_path+'/tokenizer', return_tensors='pt')
...
class RegressionModel(nn.Module):
    def __init__(self, cfg, config_path=None, pretrained=False):
        ...
        if pretrained:
            ...
            if 't5' in cfg.model: #modelを指定しておかないとNoneになって勝手に下になる。pathを代わりに使っているとt5が入ってないから下になることがある
